...
const ProductPage = () => {
  ...
  const { addToCart, addToWishlist } = useShoppingContext();
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-12">
            ...
            <div className="md:w-3/5">
              ...
              {/* Short description */}
              <p className="text-gray-700 mb-6">{display.description}</p>
              ...
              <div className="mb-6">
                ...
                <Button 
                  ...
                  onClick={() => display && addToCart(display)}
                ...
                <div className="flex mt-3">
                  <Button 
                    ...
                    onClick={() => display && addToWishlist(display)}
                  >
