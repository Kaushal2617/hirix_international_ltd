...
const NewArrivalsPage = () => {
  // Only consider newArrival products
  const newArrivalProducts = allProducts.filter(p => p.newArrival);
              ...
              {filteredProducts.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {filteredProducts.map((product) => (
                    <div key={product.id} className="group overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow rounded-lg">
                      <img
                        src={product.image}
                        alt={product.name}
